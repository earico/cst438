...
public class SystemTestMultiplyGame {
	...
	public static final String CHROME_DRIVER_FILE_LOCATION =
                         "/Users/eleazarrico/Downloads/chromedriver-mac-arm64/chromedriver";
	...
	public void playGoodGame() throws InterruptedException {
		// find web elements by id= or name= 
				...
				WebElement historyLink = 
		                 driver.findElement(By.xpath("//a[@href='/history']"));
				// go to history page
				historyLink.click();
				Thread.sleep(SLEEP_DURATION);
				...
				assertThat(Integer.parseInt(listTd.get(1).getText())).isEqualTo(b);		assertThat(Integer.parseInt(listTd.get(2).getText())).isEqualTo(a*b);
